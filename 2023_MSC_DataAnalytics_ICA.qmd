...
Create an interactive web application using Quarto Dashboards and Shiny to display and interact with data from the database. You are required develop an interactive web application containing **two pages/tabs** which allow the following:
