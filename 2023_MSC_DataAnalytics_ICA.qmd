...
Output the results in a **Shiny Application Project**. The application does **not** need to be published to a remote server and may be run from your machine. This will be a second, and separate project from the Quarto Website produced for Parts A & B.
...
Note, in order to receive the marks for this component you should include a short paragraph in a separate page, entitled *Technology Exploration.qmd*, which summarises what component(s) you have added, inside the **Quarto Website** from Parts A & B.

### Part E - Quality & Conclusions (20 Marks)

You are required to present **two** separate project repos: 

* **Quarto Website** which brings together Parts A, B, D.
* **Shiny Application** which hosts the Quarto Dashboard for Part C.
